---
title: "Meta-Clustering on KD6 Essential Data"
...
## output files
FILE_OUT_AVG_TARGET="img/heatmap-kd6-essential-avg-target-clusters.pdf"
FILE_OUT_AVG_GENE="img/heatmap-kd6-essential-avg-gene-clusters.pdf"
FILE_OUT_AVG_BOTH="img/heatmap-kd6-essential-avg-both-clusters.pdf"
FILE_OUT_FINAL="img/heatmap-kd6-essential-nnclusters-ordered.pdf"
...
```{r plt_ordered_cluster_mzdwui, fig.width=8, fig.height=6}
idx_clusters_targets <- c(14,18,11,16,13,9,12,2,5,15,1,6,8,3,7,4,10,17)

pheatmap(mzdwui_cluster_gene[idx_clusters_targets, idx_genes_clean], 
         color=COLORS_BWR,
         breaks=breaks_zdwui,
         fontsize_col=1, fontsize_row=10,
...
pheatmap(mzdwui_cluster_cluster, 
         color=COLORS_BWR,
         breaks=breaks_zdwui,
         fontsize_col=10, fontsize_row=10,
         show_colnames=TRUE, show_rownames=TRUE, scale='none', 
