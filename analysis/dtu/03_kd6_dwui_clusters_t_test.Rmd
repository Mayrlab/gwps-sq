---
title: "Differential WUI Per Cluster - t Test"
...
FILE_OUT="data/dwui/df_dwui_kd6_clusters.t_test.tsv.gz"
...
df_tests <- bplapply(wui_clusters, function (df_cluster) {
    ...
    bind_rows(df_ntp, df_cluster) %>%
        ...
        mutate(test=map(data, ~ tidy(t.test(wui ~ cluster_id, data=.x))),
