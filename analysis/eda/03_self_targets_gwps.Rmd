---
title: "Self-Targeted Isoform Changes - GWPS"
...
Yes, a bunch. However, we have over 6K, so not in a crunch to incorporate these.
...
Yes, we have significance.

# Random Permutations
We can also check random permutations of the gene-target pairs, which provides
a null distribution for AWUI in targeted cells.
...
Yes, significant and similar effect size.
...
Yes, but the effect size is two orders of magnitude smaller.
