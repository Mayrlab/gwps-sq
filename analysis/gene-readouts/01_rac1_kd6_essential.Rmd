---
title: "RAC1 SU-LU Plots - KD6 Essential"
...
set.seed(20210818)
GENE="RAC1"
FILE_SCE="data/sce/kd6_essential.annot.txs.Rds"

LBL_TXS=c("ENST00000348035.9-UTR+33"="cts_lu", 
          "ENST00000348035.9-UTR-1277"="cts_su")
FILE_OUT=sprintf("tbl/%s_kd6_essential_targets.xlsx", tolower(GENE))
DIR_IMG_OUT=sprintf("img/gene-readouts/kd6-essential/%s-", tolower(GENE))
...
```{r prepare_data}
cts_gene_cell <- counts(sce[names(LBL_TXS),])
cts_total_cell <- colSums(counts(sce))
