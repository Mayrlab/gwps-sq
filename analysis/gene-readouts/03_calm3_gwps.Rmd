...
gene CALM3 as having one of the highest dynamic ranges of isoform usage accompanied by 
robust gene expression in almost all cell types. In this exploratory analysis, we
use abundance of CALM3 isoforms as a readout for shifts in isoform usage.
...
LBL_TXS=c("ENST00000291295.14"="cts_lu", 
          "ENST00000596362.1"="cts_mu1",
          "ENST00000599839.5"="cts_mu2", 
          "ENST00000597743.5"="cts_su")
