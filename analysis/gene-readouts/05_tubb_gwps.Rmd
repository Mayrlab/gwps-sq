...
In this exploratory analysis, we use abundance of TUBB isoforms as a readout for 
...
LBL_TXS=c("ENST00000681435.1"="cts_lu", 
          "ENST00000327892.13-UTR-265"="cts_mu",
          "ENST00000327892.13-UTR-847"="cts_su")
